...
const TopBar = () => {
  return (
    <div className="relative bg-[#191919] text-white">
      ...
      <div
        aria-hidden
        className="absolute left-0 top-0 h-[38px] bg-[#ff9934] mobile:hidden"
        style={{ width: "calc((100vw - 1280px) / 2 + 320px)" }}
      />

      <div className="container mx-auto px-6 h-[38px] flex items-center justify-between relative z-10 mobile:h-auto mobile:py-2 mobile:flex-col mobile:gap-2 mobile:px-4">
        <div className="bg-[#ff9934] px-6 h-full flex items-center text-white font-medium text-sm mobile:px-3 mobile:h-auto mobile:py-1 mobile:w-full mobile:justify-center mobile:text-xs">
          Al Madina Rd, King Fahad, Jubail 35514
        </div>

        <div className="flex items-center gap-4 text-sm mobile:gap-3 mobile:text-xs mobile:w-full mobile:justify-center">
          <span className="mobile:hidden">info@nalarabia.com</span>
